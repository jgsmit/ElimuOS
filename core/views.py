...
def super_admin_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.SUPER_ADMIN])


@role_required(CustomUser.Role.SCHOOL_ADMIN)
def school_admin_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.SCHOOL_ADMIN])


@role_required(CustomUser.Role.TEACHER)
def teacher_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.TEACHER])


@role_required(CustomUser.Role.STUDENT)
def student_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.STUDENT])


@role_required(CustomUser.Role.PARENT)
def parent_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.PARENT])


@role_required(CustomUser.Role.COUNSELOR)
def counselor_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.COUNSELOR])


@role_required(CustomUser.Role.LIBRARIAN)
def librarian_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.LIBRARIAN])


@role_required(CustomUser.Role.HOSTEL_STAFF)
def hostel_staff_dashboard(request):
    return render(request, DASHBOARD_TEMPLATES[CustomUser.Role.HOSTEL_STAFF])
